<?php
	...
	$sql = "select Data_Hora_Medicao,Valor_Medicao_Temperatura from medicao_temperatura where Data_Hora_Medicao >= now() - interval 5 minute order by Data_Hora_Medicao asc";
